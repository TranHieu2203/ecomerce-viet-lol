          ...
          {({ open, close }) => (
            <>
              ...
              <Transition
                show={open}
                as={Fragment}
                enter="transition duration-240 ease-friendly motion-reduce:transition-none"
                enterFrom="opacity-0 -translate-x-1 motion-reduce:transform-none"
                enterTo="opacity-100 translate-x-0"
                leave="transition duration-180 ease-standard motion-reduce:transition-none"
                leaveFrom="opacity-100 translate-x-0"
                leaveTo="opacity-0 -translate-x-1 motion-reduce:transform-none"
              >
                <PopoverPanel
                  static
                  portal
